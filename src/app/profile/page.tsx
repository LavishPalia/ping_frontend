...
import { ArrowLeft, Pencil, Save, User, UserCircle, X } from "lucide-react";
  ...
  const submitHandler = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `${user_service}/api/v1/users/update`,
        {
          name,
        },
        {
            ...
            <div className="space-y-6">
              <div>
                ...
                {isEdit ? (
                  ...
                  <div className="bg-gray-700 flex items-center justify-between p-4 rounded-lg border border-gray-600">
